...
interface Errors {
  ...
  individual_user_id: string | undefined;
}
...
const validate = data => {
  ...
  const zendeskOrganizations = JSON.parse(
  ...
  const checkedData = {
    ...
    individual_user_id: checkField(data.individual_user_id)
  };
  ...
  // Ticket ID da MSR
  if (
    !Validator.isNumeric(checkedData.individual_ticket_id, { no_symbols: true })
  ) {
  ...
  if (Validator.isEmpty(checkedData.individual_user_id)) {
    errors = { ...errors, individual_user_id: "Selecione uma MSR" };
  }
  ...
  if (Validator.isEmpty(checkedData.volunteer_name)) {
    errors = {
      ...errors,
      volunteer_name: "O nome da voluntária é obrigatório"
    };
  }

  // User ID da Voluntária
  if (
    !Validator.isNumeric(checkedData.volunteer_user_id, { no_symbols: true })
  ) {
    errors = {
      ...errors,
      volunteer_user_id: "user_id da voluntária deve conter apenas números"
    };
  }
  ...
  if (Validator.isEmpty(checkedData.volunteer_registry)) {
    errors = {
      ...errors,
      volunteer_registry: "A voluntária precisa ter um número de registro"
    };
  }
  ...
  if (Validator.isEmpty(checkedData.volunteer_phone)) {
    errors = {
      ...errors,
      volunteer_phone: "A voluntária precisa ter um número de telefone"
    };
  }
  if (!Validator.isNumeric(checkedData.volunteer_phone)) {
    errors = {
      ...errors,
      volunteer_phone: "Número da voluntária não é válido"
    };
  }
  ...
  if (Validator.isEmpty(checkedData.volunteer_organization_id)) {
    errors = {
      ...errors,
      volunteer_organization_id: "A voluntária precisa ter um organization_id"
    };
  }
  if (
    !Validator.isNumeric(checkedData.volunteer_organization_id, {
      no_symbols: true
    })
  ) {
    errors = {
      ...
      volunteer_organization_id:
        "organization_id da voluntária não contém apenas números"
    };
  }
  if (
    Validator.equals(
      checkedData.volunteer_organization_id,
      zendeskOrganizations.individual
    )
  ) {
    errors = {
      ...errors,
      volunteer_organization_id: "organization_id da voluntária não é válido"
    };
  }
  return {
    errors,
