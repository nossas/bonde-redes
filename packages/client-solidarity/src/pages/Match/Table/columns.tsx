...
const columns = [
  ...
  },
  {
    ...
    Cell: ({ value }: valueArrayString) => (value ? <span>{value}</span> : "-"),
    width: 200
  },
  {
  ...
  },
  {
    accessor: "ticket_id",
    Header: "Link",
    Cell: ({ value }: valueArrayString) =>
      value ? (
        <a
          href={`https://mapadoacolhimento.zendesk.com/agent/tickets/${value}`}
          target="_blank"
