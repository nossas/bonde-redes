...
const App = () => (
    <StoreProvider store = {store}><Router history = {history}><SessionProvider>
    <AppWrapper className = "app"><Header /><AppBody className = "app-body">
    <Route exact path = "/"><Redirect to = "/match" />
    </Route>
