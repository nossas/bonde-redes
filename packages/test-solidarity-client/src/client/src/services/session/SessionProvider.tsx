...
class SessionProvider extends React.Component {
  ...
  render() {
    return !this.state.signing ? (
      ...
      <FullPageLoading bgColor="#fff" message="Carregando dados de usuário" />
    );
  }
}

export const SessionHOC = (WrappedComponent: any) =>
  class extends React.Component {
    static contextType = SessionContext;

    render() {
      return <WrappedComponent {...this.props} session={this.context} />;
    }
  };
